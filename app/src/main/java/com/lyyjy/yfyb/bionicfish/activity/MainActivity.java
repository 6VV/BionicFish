...
public class MainActivity extends ParentActivity implements IRemoteCallback {
    ...
    private MenuItem mDrawerItemRemote;
...
//        RelativeLayout layoutMain = (RelativeLayout) inflater.inflate(R.layout.activity_main, null);
        ...
        mDrawerItemRemote=mNavigationView.getMenu().findItem(R.id.action_remote);
        ...
        switch (item.getItemId()){
            ...
            case R.id.action_search:{
                if (VersionControl.isWifi()){
                    startActivity(new Intent(MainActivity.this, SearchWifiActivity.class));
                }else {
...
//                    MyHandler.sendMessage(msg);
    ...
    private void updateRemoteIcon() {
        if (VersionControl.isWifi()){
            mItemRemote.setVisible(false);
            mDrawerItemRemote.setVisible(false);
        }else{
            mItemRemote.setVisible(true);
            mDrawerItemRemote.setVisible(true);

            if (RemoteFactory.getRemote().isEnabled()){
                mItemRemote.setIcon(R.drawable.bluetooth_enable);
                mDrawerItemRemote.setIcon(R.drawable.bluetooth_enable);
            }else{
                mItemRemote.setIcon(R.drawable.bluetooth_disabled);
                mDrawerItemRemote.setIcon(R.drawable.bluetooth_disabled);
            }
        }
    }
